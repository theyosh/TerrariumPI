...
class terrariumTranslations(object):
  ...
  def __load(self):
    ...
    self.translations['switch_field_timer_on_duration'] = _('Holds the period in minutes that the power switch is on within the total timer window.')
    self.translations['switch_field_timer_off_duration'] = _('Holds the period in minutes that the power switch is off within the total timer window.')
    ...
    self.translations['switch_field_dimmer_off_duration'] = _('Holds the amount of seconds for the duration in which it decreases the power.')
    ...
    self.translations['audio_playlist_field_shuffle'] = _('Toggle on to enable shuffling of the audio files.')
    ...
    self.translations['environment_field_day_night_source'] = _('Holds the source that is used to determine when it is day or night.')
    ...
    self.translations['environment_field_on_duration'] = _('Holds the period in minutes that this environment part is powered on within the total timer window.')
    self.translations['environment_field_off_duration'] = _('Holds the period in minutes that this environment part is powered off within the total timer window.')
    ...
    self.translations['environment_field_watertank_volume'] = _('Holds the water volume in litres.')
    ...
    self.translations['environment_field_door_state'] = _('Select when the power switches can toggle. When the door is open, closed or just always')
    # End environment
    ...
    self.translations['notification_email_serverport'] = _('Holds the mail server port number. SSL and TLS will be autodetected.')
    self.translations['notification_email_email_username'] = _('Holds the username for authentication with the mail server if needed.')
    self.translations['notification_email_email_password'] = _('Holds the password for authentication with the mail server if needed.')
    ...
    self.translations['notification_telegram_username'] =  _('Holds the Telegram username that is allowed for receiving messages. Can be multiple usernames separated by a comma. More information %shere%s') % ('<a href=\'https://core.telegram.org/bots#6-botfather\' target=\'_blank\'>','</a>')
    ...
    self.translations['system_field_soundcard'] = _('Holds the sound card that is used for playing audio.')
    ...
    self.translations['system_field_water_price'] = _('Holds the amount of euro/dollar per 1000 litres water.')
    ...
    self.translations['system_field_windspeed_indicator'] = _('Choose the wind speed indicator. The software will recalculate to the chosen indicator.')

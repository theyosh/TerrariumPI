% include('inc/page_header.tpl')
        ...
        <div class="row sensor">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2><span aria-hidden="true" class="glyphicon glyphicon-fire"></span> <span class="title">{{sensor_type.title()}}</span> <small>live...</small> <span class="badge bg-red" style="display:none;">warning</span></h2>

...
<head>
  ...
  <link href="/gentelella/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"><!-- PNotify -->
  ...
  <link href="/gentelella/vendors/pnotify/dist/pnotify.nonblock.css" rel="stylesheet"><!-- Select2 -->
  <link href="/gentelella/vendors/select2/dist/css/select2.min.css" rel="stylesheet"><!-- leaflet -->

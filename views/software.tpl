              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                  <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#raspbian" id="raspbian-tab" role="tab" data-toggle="tab" aria-expanded="true">Raspbian</a>
                    </li>
                    <li role="presentation" class=""><a href="#owfs" role="tab" id="owfs-tab" data-toggle="tab" aria-expanded="false">OWFS</a>
                    </li>
                    <li role="presentation" class=""><a href="#mjpg_streamer" role="tab" id="mjpg_streamer-tab2" data-toggle="tab" aria-expanded="false">MJPG-streamer</a>
                    </li>
                    <li role="presentation" class=""><a href="#python" role="tab" id="python-tab2" data-toggle="tab" aria-expanded="false">Python</a>
                    </li>
                    <li role="presentation" class=""><a href="#webinterface" role="tab" id="webinterface-tab2" data-toggle="tab" aria-expanded="false">Webinterface</a>
                    </li>
                  </ul>
                  <div id="myTabContent" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="raspbian" aria-labelledby="raspbian-tab">
                      <p class="lead">Raspbian</span>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="owfs" aria-labelledby="owfs-tab">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="mjpg_streamer" aria-labelledby="mjpg_streamer-tab">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="python" aria-labelledby="python-tab">
                      ...
                      <div class="col-xs-3">
                        ...
                        <ul class="nav nav-tabs tabs-right">
                          <li class="active"><a href="#python_bottle" data-toggle="tab">Bottle</a>
                          </li>
                          <li><a href="#python_ow" data-toggle="tab">OW</a>
                          </li>
                          <li><a href="#python_pylibftdi" data-toggle="tab">pylibftdi</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="webinterface" aria-labelledby="webinterface-tab">

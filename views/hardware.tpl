                  ...
                  <div id="myTabContent" class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="sensors" aria-labelledby="sensors-tab">
                      <div class="col-xs-9">
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="1w_temperature">
                            ...
                            <p>A simple temperature sensor consisting of a DS18B20 sensors on 2m of cable with an RJ45 plug on the other end.<br />Wired for parasitic or external power (see options below).<br />Unsure which power option to choose? See the SWE0 Information page linked below for further information. <a href="http://www.sheepwalkelectronics.co.uk/product_info.php?cPath=23&products_id=52" target="_blank" title="SWE0 Temperature Sensor">http://www.sheepwalkelectronics.co.uk/product_info.php?cPath=23&products_id=52</a></p></div>
                      ...
                      <div class="col-xs-3">
                        ...
                        <ul class="nav nav-tabs tabs-right">
                          <li class="active"><a href="#1w_adapter" data-toggle="tab">Host adapter</a>
                          </li>
                          <li><a href="#1w_temperature" data-toggle="tab">Temperature</a>
                          </li>
                          <li><a href="#1w_humidity" data-toggle="tab">Humidity</a>
                          </li>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="webcam" aria-labelledby="webcam-tab">
                      ...
                      <div class="col-xs-3">
                        ...
                        <!-- Nav tabs -->
                        <ul class="nav nav-tabs tabs-right">
                          <li class="active"><a href="#webcam_rpi" data-toggle="tab">PiCam</a>
                          </li>
                          <li><a href="#webcam_usb" data-toggle="tab">USB</a>
                          </li>
                          <li><a href="#webcam_online" data-toggle="tab">Online</a>
                          </li>
                        </ul>
                      </div>
                    </div>

            ...
            <div class="" data-example-id="togglable-tabs" role="tabpanel">
              <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
                ...
                <li class="" role="presentation">
                  <a aria-expanded="false" data-toggle="tab" href="#tab_software" id="software-tab" role="tab">Used software</a>
                </li>
                <li class="" role="presentation">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div aria-labelledby="software-tab" class="tab-pane fade" id="tab_software" role="tabpanel">

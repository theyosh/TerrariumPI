    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-md-4 col-lg-3">
        <Field
          ...
          invalid="{$_('sensors.settings.address.invalid', {
      ...
      <div class="col-10 col-sm-10 col-md-8 col-lg-3">
        <Field
          ...
          invalid="{$_('sensors.settings.name.invalid', {
    ...
    <div class="row">
      <div class="col-6 col-sm-6 col-md-6 col-lg-2">
        <Field
          ...
          invalid="{$_('sensors.settings.alarm_min.invalid', {
      ...
      <div class="col-6 col-sm-6 col-md-6 col-lg-2">
        <Field
          ...
          invalid="{$_('sensors.settings.alarm_max.invalid', {
            default: 'The entered value is not valid. It needs to be number.',
          })}"
        />
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-2">
        <Field
          ...
          invalid="{$_('sensors.settings.limit_min.invalid', {
            default: 'The entered value is not valid. It needs to be number.',
          })}"
        />
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-2">
        <Field
          ...
          invalid="{$_('sensors.settings.limit_max.invalid', {
            default: 'The entered value is not valid. It needs to be number.',
          })}"
        />
      </div>
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-2">
        <Switch
          ...
          help="{$_('sensors.settings.exclude_avg.help', {
            default: 'Exclude this sensors from average calculations.',
          })}"
        />
      </div>
    </div>
        ...
        <div class="collapse row pt-3" id="callibration">
          ...
          >
            <Field
              ...
              help="{$_('sensors.settings.calibration.chirp_min_moist.help', {
                default: 'Enter the minimum moist value.',
              })}"
          ...
          >
            <Field
              ...
              help="{$_('sensors.settings.calibration.chirp_max_moist.help', {
                default: 'Enter the maximum moist value.',
              })}"
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4" class:d-none="{sensor_type !== 'css811'}">
            <Select
              ...
              label="{$_('sensors.settings.calibration.ccs811_compensation_sensors.label', {
                default: 'Compensation sensors',
              })}"
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-2" class:d-none="{sensor_type !== 'light'}">
            <Field
              ...
              help="{$_('sensors.settings.calibration.light_threshold.help', {
                default: 'Enter the value when considered the lights are on.',
              })}"

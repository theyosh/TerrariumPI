    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-3">
        <Field
          ...
          invalid={$_('buttons.settings.name.invalid', {
        ...
        <div class="collapse row pt-3" id="button_callibration">
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4" class:d-none={selected_hardware !== 'ldr'}>
            <Field
              ...
              placeholder={$_('buttons.settings.calibration.ldr_capacitor.placeholder', {
                default: 'Enter the capacitor value in µF',
              })}
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-4" class:d-none={selected_hardware !== 'remote'}>
            <Field
              ...
              placeholder={$_('buttons.settings.calibration.timeout.placeholder', {
                default: 'Enter the time out in seconds',
              })}

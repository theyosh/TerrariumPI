    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-2">
        <Field
          ...
          invalid="{$_('relays.settings.address.invalid', {
      ...
      <div class="col-12 col-sm-12 col-md-12 col-lg-3">
        <Field
          ...
          invalid="{$_('relays.settings.name.invalid', {
        ...
        <div class="collapse row pt-3" id="callibration">
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" class:d-none="{hardware_type === 'gpio'}">
            <Field
              ...
              help="{$_('relays.settings.calibration.dimmer_max_power.help', {
                default: 'The maximum power for this dimmer.',
              })}"
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3" class:d-none="{hardware_type !== 'dimmerlink-i2c-dimmer'}">
            <Select
              name="calibration.dimmer_curve"
              value="{$formData.calibration?.dimmer_curve}"
              required="{false}"
              options="{[
                { value: 0, text: 'Linear' },
                { value: 1, text: 'RMS' },

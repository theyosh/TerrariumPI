...
class terrariumWebserver(object):
    ...
    def __template_variables(self, template):
        ...
        variables = {
            ...
            "gauge_values_alarm": str(self.engine.settings["gauge_values_alarm"]).lower() == 'on',
            "gauge_values_limit": str(self.engine.settings["gauge_values_limit"]).lower() == 'on',
            "gauge_values_measurements": str(self.engine.settings["gauge_values_measurements"]).lower() == 'on',

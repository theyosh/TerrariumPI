...
class terrariumWebserver(object):
    ...
    def __template_variables(self, template):
        ...
        variables = {
            ...
            "gauge_values_alarm": str(str(self.engine.settings["gauge_values_alarm"]).lower() == 'on').lower(),
            "gauge_values_limit": str(str(self.engine.settings["gauge_values_limit"]).lower() == 'on').lower(),
            "gauge_values_measurements": str(str(self.engine.settings["gauge_values_measurements"]).lower() == 'on').lower(),
